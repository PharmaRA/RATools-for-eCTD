...
describe('artifactDisplay', () => {
  ...
  it('builds artifact table columns', () => {
    ...
    expect((actionElement as ReactElement<{ jobId: string; artifactName: string; href?: string }>).props.jobId)
      .toBe('job-1')
    expect((actionElement as ReactElement<{ jobId: string; artifactName: string; href?: string }>).props.artifactName)
      .toBe('PublishReport')
    expect((actionElement as ReactElement<{ jobId: string; artifactName: string; href?: string }>).props.href)
      .toBeUndefined()
